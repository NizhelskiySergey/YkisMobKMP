...
/**
 * [MeterRemoteRepository] — Интерфейс удаленного взаимодействия с API счетчиков ЮКИС.
 * ИСПРАВЛЕНО НАМЕРТВО: Выполнена строгая замена типов Int на Long без изменения сигнатур методов!
 * Намертво зафиксирован для полной замены.
 */
interface MeterRemoteRepository {
