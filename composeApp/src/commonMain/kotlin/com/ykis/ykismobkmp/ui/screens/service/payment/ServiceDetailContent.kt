package com.ykis.ykismobkmp.ui.screens.service.payment
...
import com.ykis.ykismobkmp.ui.screens.service.detail.ColumnItemInTable
import com.ykis.ykismobkmp.ui.screens.service.detail.TableDivider
...
fun ServiceDetailContentWrapper(
  ...
  val viewModel = koinInject<ServiceScreenModel>()
    ...
    baseUIState.uid?.let { currentUid ->
      ...
      viewModel.getDetailService(
        params = ServiceParams(
          ...
          houseId = baseUIState.apartment.houseId, // Сквозной Long ID СУБД
          total = 0L.toByte(),
          year = selectedChip,
