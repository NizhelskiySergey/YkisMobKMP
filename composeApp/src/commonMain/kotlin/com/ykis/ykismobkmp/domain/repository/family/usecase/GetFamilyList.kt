package com.ykis.ykismobkmp.domain.repository.family.usecase
...
class GetFamilyList(
  ...
  operator fun invoke(addressId: Long): Flow<Resource<List<FamilyEntity>>> = flow {
    ...
    try {
      ...
      val response = repository.getFamilyList(addressId)
